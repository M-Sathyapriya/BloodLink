...
const KGHospitalInfo = () => {
  return (
    ...
    >
      ...
      <InfoItem label="Address" value="121, Ayyappa Chetty St, tambaram\nChennai, Tamil Nadu 600001.\n(Private)" />
      <InfoItem label="Email" value="KGHospital121@gmail.com" />
